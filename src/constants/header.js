...
export const PACKET_TYPE = Object.freeze({
  ...
  // 건물 구매
  PURCHASE_BUILDING_REQUEST: 90,
  PURCHASE_BUILDING_RESPONSE: 91,
  ADD_ENEMY_BUILDING_NOTIFICATION: 92,

  // 유닛 생성
  SPAWN_UNIT_REQUEST: 100,
  SPAWN_UNIT_RESPONSE: 101,
  SPAWN_ENEMY_UNIT_NOTIFICATION: 102,

  // 유닛 공격
  ATTACK_UNIT_REQUEST: 200,
  ATTACK_UNIT_RESPONSE: 201,
  ENEMY_UNIT_ATTACK_NOTIFICATION: 202,

  // 유닛 피격
  UNIT_ATTACKED_REQUEST: 300,
  UNIT_ATTACKED_RESPONSE: 301,
  ENEMY_UNIT_ATTACKED_NOTIFICATION: 302,
  ...
  ENEMY_ATTACK_BASE_NOTIFICATION: 602,
  BASE_ATTACKED_REQUEST: 603,
  BASE_ATTACKED_RESPONSE: 604,
  ENEMY_BASE_ATTACKED_NOTIFICATION: 605,
